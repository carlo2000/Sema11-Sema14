...
//import com.example.repasoo_sem11.placeholder.PlaceholderContent.PlaceholderItem;
import com.example.repasoo_sem11.databinding.FragmentItemBinding;
...
public class MyNotaRecyclerViewAdapter extends RecyclerView.Adapter<MyNotaRecyclerViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.tvContentido.setText(holder.mItem.getContenido());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public final TextView tvContentido;
        ...
        public ViewHolder(View view) {
            ...
            tvContentido = view.findViewById(R.id.textViewContenido);
